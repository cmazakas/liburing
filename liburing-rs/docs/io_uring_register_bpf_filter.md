...
> - If **IO_URING_BPF_FILTER_SZ_STRICT** is set, registration fails with
>   **-EMSGSIZE** if the sizes differ.
>
> - If **IO_URING_BPF_FILTER_SZ_STRICT** is not set, registration is
...
>
> - Regardless of **IO_URING_BPF_FILTER_SZ_STRICT**, registration always
