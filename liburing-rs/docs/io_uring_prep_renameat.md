...
The [io_uring_prep_renameat] function prepares a renameat request.
The submission queue entry *sqe* is setup to use the old directory file
...
The [io_uring_prep_rename] function prepares a rename request. The
...
These functions prepare an async [renameat2](https://man7.org/linux/man-pages/man2/renameat2.2.html) or [rename](https://man7.org/linux/man-pages/man2/rename.2.html)
request. If *flags* is zero, then this call is similar to the
[renameat](https://man7.org/linux/man-pages/man2/renameat.2.html) system call. See those man pages for details.
...
[io_uring_get_sqe], [io_uring_submit], [renameat](https://man7.org/linux/man-pages/man2/renameat.2.html),
[renameat2](https://man7.org/linux/man-pages/man2/renameat2.2.html), [rename](https://man7.org/linux/man-pages/man2/rename.2.html)
