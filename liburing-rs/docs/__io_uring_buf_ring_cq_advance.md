Advance index of provided buffer and CQ
ring

# DESCRIPTION

The [io_uring_buf_ring_cq_advance] commits *count* previously added
...
amount. This effectively bundles both a [io_uring_buf_ring_advance]
call and a [io_uring_cq_advance] into one operation. Since updating
