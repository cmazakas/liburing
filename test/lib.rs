...
pub unsafe extern "C" fn io_uring_prep_accept_direct(
    sqe: *mut io_uring_sqe, fd: c_int, addr: *mut sockaddr, addrlen: *mut socklen_t, flags: c_int, file_index: c_uint,
) {
...
pub unsafe extern "C" fn io_uring_prep_openat_direct(
    sqe: *mut io_uring_sqe, dfd: c_int, path: *const c_char, flags: c_int, mode: mode_t, file_index: c_uint,
) {
...
pub unsafe extern "C" fn io_uring_prep_openat2_direct(
    sqe: *mut io_uring_sqe, dfd: c_int, path: *const c_char, how: *mut open_how, file_index: c_uint,
) {
...
pub unsafe extern "C" fn io_uring_prep_msg_ring_fd(
    sqe: *mut io_uring_sqe, fd: c_int, source_fd: c_int, target_fd: c_int, data: u64, flags: c_uint,
) {
...
pub unsafe extern "C" fn io_uring_prep_socket_direct(
    sqe: *mut io_uring_sqe, domain: c_int, r#type: c_int, protocol: c_int, file_index: c_uint, flags: c_uint,
) {
...
pub unsafe extern "C" fn io_uring_buf_ring_mask(ring_entries: u32) -> c_int {
    liburing_rs::io_uring_buf_ring_mask(ring_entries)
}
